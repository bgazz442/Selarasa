      ...
      <section className="section-padding bg-white dark:bg-gray-800">
        <div className="container-max text-center">
          ...
          <div className="flex justify-center space-x-6">
            <a href="#" className="w-12 h-12 bg-earth-100 dark:bg-earth-700 rounded-full flex items-center justify-center hover:bg-leaf-100 dark:hover:bg-leaf-900 transition-colors">
